...
namespace Kopernicus.UI
{
    ...
    public class ToolbarButton : MonoBehaviour
    {
        ...
        public void DrawKopernicusWindow(int windowId)
        {
            ...
            RuntimeUtility.RuntimeUtility.KopernicusConfig.KSCLightsAlwaysOn = GUILayout.Toggle(RuntimeUtility.RuntimeUtility.KopernicusConfig.KSCLightsAlwaysOn, " KSCLightsAlwaysOn: Whether or not to force the KSC Lights to always be on.", toggleStyle);
