...
namespace Kopernicus.UI
{
    ...
    public class ToolbarButton : MonoBehaviour
    {
        ...
        public void DrawKopernicusWindow(int windowId)
        {
            ...
            RuntimeUtility.RuntimeUtility.KopernicusConfig.CleanupKSCScatters = GUILayout.Toggle(RuntimeUtility.RuntimeUtility.KopernicusConfig.CleanupKSCScatters, "CleanupKSCScatters: Whether or not to remove scatters that spawn on or close to the KSC. False by default. Requires scene switch to change.", toggleStyle);
