...
namespace Kopernicus
{
    namespace Configuration
    {
        ...
        public abstract class ComponentLoader<T> : ICreatable<IComponent<T>>, ITypeParser<IComponent<T>> where T : IComponentSystem<T>
        {
            /// <summary>
        ...
        [RequireConfigType(ConfigType.Node)]
        public class ComponentLoader<TSystem, TComponent> : ComponentLoader<TSystem>, ICreatable<TComponent>, ITypeParser<TComponent>
