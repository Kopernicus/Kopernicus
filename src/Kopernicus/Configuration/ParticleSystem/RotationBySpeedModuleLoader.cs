...
namespace Kopernicus
{
    namespace Configuration
    {
        ...
        public class RotationBySpeedModuleLoader : ITypeParser<ParticleSystem.RotationBySpeedModule>
        {
            // The module we are editing
            private ParticleSystem.RotationBySpeedModule _value;
            public ParticleSystem.RotationBySpeedModule Value
            {
                get { return _value; }
                set { _value = value; }
            }
            ...
            [ParserTarget("range")]
            [KittopiaDescription("Apply the rotation curve between these minimum and maximum speeds.")]
            ...
            public RotationBySpeedModuleLoader()
            {
                _value = new ParticleSystem.RotationBySpeedModule();
            }

            // Edit an existing module
            [KittopiaConstructor(KittopiaConstructor.Parameter.Element, purpose = KittopiaConstructor.Purpose.Edit)]
            public RotationBySpeedModuleLoader(ParticleSystem.RotationBySpeedModule module)
            {
                _value = module;
            }

            public static implicit operator ParticleSystem.RotationBySpeedModule(RotationBySpeedModuleLoader loader)
            {
                return loader.Value;
            }

            public static implicit operator RotationBySpeedModuleLoader(ParticleSystem.RotationBySpeedModule value)
            {
                return new RotationBySpeedModuleLoader(value);
            }
        }
    }
}