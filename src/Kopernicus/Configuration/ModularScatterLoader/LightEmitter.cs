...
namespace Kopernicus.Configuration.ModularScatterLoader
{
    ...
    public class LightEmitter : ComponentLoader<ModularScatter, LightEmitterComponent>
    {
        ...
        [ParserTarget("alreadyLightmapped")]
        public NumericParser<Boolean> AlreadyLightmapped
        {
            get { return Value.Prefab.alreadyLightmapped; }
            set { Value.Prefab.alreadyLightmapped = value; }
        }
