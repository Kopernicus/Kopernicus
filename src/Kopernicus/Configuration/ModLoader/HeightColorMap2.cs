...
namespace Kopernicus.Configuration.ModLoader
{
    ...
    public class HeightColorMap2 : ModLoader<PQSMod_HeightColorMap2>
    {
        // Land class loader 
        [RequireConfigType(ConfigType.Node)]
        public class LandClassLoader : IPatchable, ITypeParser<PQSMod_HeightColorMap2.LandClass>
        {
            // Land class object
            public PQSMod_HeightColorMap2.LandClass Value { get; set; }
            ...
            public LandClassLoader()
            {
                ...
                Value = new PQSMod_HeightColorMap2.LandClass("class", 0.0, 0.0, UnityEngine.Color.white, UnityEngine.Color.white, 0.0);
            }

            public LandClassLoader(PQSMod_HeightColorMap2.LandClass c)
            {
                Value = c;
            }
            ...
            /// </summary>
            public static implicit operator PQSMod_HeightColorMap2.LandClass(LandClassLoader parser)
            {
                return parser.Value;
            }
            ...
            /// </summary>
            public static implicit operator LandClassLoader(PQSMod_HeightColorMap2.LandClass value)
            {
        ...
        public override void Create(PQSMod_HeightColorMap2 mod, PQS pqsVersion)
        {
