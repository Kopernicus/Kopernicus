    ...
    public class HeightColorMapNoise : ModLoader<PQSMod_HeightColorMapNoise>
    {
        ...
        public class LandClassLoader : IPatchable, ITypeParser<PQSMod_HeightColorMapNoise.LandClass>
        {
            ...
            public LandClassLoader()
            {
                ...
                Value = new PQSMod_HeightColorMapNoise.LandClass("class", 0.0, 0.0, UnityEngine.Color.white, UnityEngine.Color.white, 0.0);
            }
        ...
        public override void Create(PQSMod_HeightColorMapNoise mod, PQS pqsVersion)
        {
