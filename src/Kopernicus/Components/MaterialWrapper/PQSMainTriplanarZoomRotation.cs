...
namespace Kopernicus.Components.MaterialWrapper
{
    ...
    public class PQSMainTriplanarZoomRotation : Material
    {
        // Internal property ID tracking object
        protected class Properties
        {
            // Return the shader for this wrapper
            internal const String SHADER_NAME = "Terrain/PQS/PQS Main Shader - Triplanar Zoom Rotation";
            ...
            public const String STEEP_BUMP_TILING_KEY = "_steepBumpTiling";
            public Int32 SteepBumpTilingId { get; private set; }
            ...
            public const String LOW_BUMP_TILING_KEY = "_lowBumpTiling";
            public Int32 LowBumpTilingId { get; private set; }
            ...
            public const String HIGH_BUMP_TILING_KEY = "_highBumpTiling";
            public Int32 HighBumpTilingId { get; private set; }
            ...
            {
                get { return _singleton ?? (_singleton = new Properties()); }
            }
            ...
            private Properties()
            {
                ...
                SteepBumpTilingId = Shader.PropertyToID(STEEP_BUMP_TILING_KEY);
                ...
                LowBumpTilingId = Shader.PropertyToID(LOW_BUMP_TILING_KEY);
                ...
                HighBumpTilingId = Shader.PropertyToID(HIGH_BUMP_TILING_KEY);
        ...
        public static Boolean UsesSameShader(Material m) => Configuration.MaterialLoader.PQSMainTriplanarZoomRotationLoader.UsesSameShader(m);
        ...
        // Steep Bump Tiling, default = 1
        public Single SteepBumpTiling
        {
            get { return GetFloat(Properties.Instance.SteepBumpTilingId); }
            set { SetFloat(Properties.Instance.SteepBumpTilingId, value); }
        }
        ...
        // Low Bump Tiling, default = 100000
        public Single LowBumpTiling
        {
            get { return GetFloat(Properties.Instance.LowBumpTilingId); }
            set { SetFloat(Properties.Instance.LowBumpTilingId, value); }
        }
        ...
        // High Bump Tiling, default = 100000
        public Single HighBumpTiling
        {
            get { return GetFloat(Properties.Instance.HighBumpTilingId); }
            set { SetFloat(Properties.Instance.HighBumpTilingId, value); }
        }
        ...
        public PQSMainTriplanarZoomRotation() : base(Properties.Shader)
        {
        }

        [Obsolete("Creating materials from shader source String is no longer supported. Use Shader assets instead.")]
        public PQSMainTriplanarZoomRotation(String contents) : base(contents)
        {
            shader = Properties.Shader;
        }

        public PQSMainTriplanarZoomRotation(Material material) : base(material)
        {
            // Throw exception if this material was not the proper material
            if (material.shader.name != Properties.SHADER_NAME)
                throw new InvalidOperationException(
                    "Type Mismatch: Terrain/PQS/PQS Main Shader - Triplanar Zoom Rotation shader required");
        }
    }
}
