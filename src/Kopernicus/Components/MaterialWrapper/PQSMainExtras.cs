...
namespace Kopernicus.Components.MaterialWrapper
{
    ...
    public class PqsMainExtras : Material
    {
        ...
        protected class Properties
        {
            ...
            public const String LOW_BUMP_FAR_TILING_KEY = "_lowBumpFarTiling";
            ...
            public const String MID_BUMP_FAR_TILING_KEY = "_midBumpFarTiling";
            ...
            public const String HIGH_BUMP_FAR_TILING_KEY = "_highBumpFarTiling";
            ...
            private Properties()
            {
                ...
                LowBumpFarTilingId = Shader.PropertyToID(LOW_BUMP_FAR_TILING_KEY);
                ...
                MidBumpFarTilingId = Shader.PropertyToID(MID_BUMP_FAR_TILING_KEY);
                ...
                HighBumpFarTilingId = Shader.PropertyToID(HIGH_BUMP_FAR_TILING_KEY);
        ...
        {
            get { return GetTextureScale(Properties.STEEP_BUMP_MAP_KEY); }
            set { SetTextureScale(Properties.STEEP_BUMP_MAP_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 SteepBumpMapOffset
        {
            get { return GetTextureOffset(Properties.STEEP_BUMP_MAP_KEY); }
            set { SetTextureOffset(Properties.STEEP_BUMP_MAP_KEY, value); }
        }
        ...
        {
            get { return GetTextureScale(Properties.LOW_TEX_KEY); }
            set { SetTextureScale(Properties.LOW_TEX_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 LowTexOffset
        {
            get { return GetTextureOffset(Properties.LOW_TEX_KEY); }
            set { SetTextureOffset(Properties.LOW_TEX_KEY, value); }
        }
        ...
        {
            get { return GetTextureScale(Properties.LOW_BUMP_MAP_KEY); }
            set { SetTextureScale(Properties.LOW_BUMP_MAP_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 LowBumpMapOffset
        {
            get { return GetTextureOffset(Properties.LOW_BUMP_MAP_KEY); }
            set { SetTextureOffset(Properties.LOW_BUMP_MAP_KEY, value); }
        }
        ...
        {
            get { return GetTextureScale(Properties.MID_TEX_KEY); }
            set { SetTextureScale(Properties.MID_TEX_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 MidTexOffset
        {
            get { return GetTextureOffset(Properties.MID_TEX_KEY); }
            set { SetTextureOffset(Properties.MID_TEX_KEY, value); }
        }
        ...
        {
            get { return GetTextureScale(Properties.MID_BUMP_MAP_KEY); }
            set { SetTextureScale(Properties.MID_BUMP_MAP_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 MidBumpMapOffset
        {
            get { return GetTextureOffset(Properties.MID_BUMP_MAP_KEY); }
            set { SetTextureOffset(Properties.MID_BUMP_MAP_KEY, value); }
        }
        ...
        {
            get { return GetTextureScale(Properties.HIGH_BUMP_MAP_KEY); }
            set { SetTextureScale(Properties.HIGH_BUMP_MAP_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 HighBumpMapOffset
        {
            get { return GetTextureOffset(Properties.HIGH_BUMP_MAP_KEY); }
            set { SetTextureOffset(Properties.HIGH_BUMP_MAP_KEY, value); }
        }
