...
namespace Kopernicus.Components.MaterialWrapper
{
    ...
    public class ScaledPlanetRimAerial : Material
    {
        ...
        {
            get { return GetTextureScale(Properties.RIM_COLOR_RAMP_KEY); }
            set { SetTextureScale(Properties.RIM_COLOR_RAMP_KEY, value); }
        }

        [SuppressMessage("ReSharper", "Unity.PreferAddressByIdToGraphicsParams")]
        public Vector2 RimColorRampOffset
        {
            get { return GetTextureOffset(Properties.RIM_COLOR_RAMP_KEY); }
            set { SetTextureOffset(Properties.RIM_COLOR_RAMP_KEY, value); }
        }
