...
namespace Kopernicus.Components
{
    public class KopernicusSolarPanel : PartModule
    {
        ...
        [KSPField(guiActive = true, guiActiveEditor = false, guiName = "#Kopernicus_SolarPanelFixer_Solarpanel")]//Solar panel
        ...
        public static string SolarPanelFixer_occludedby = GetLoc("SolarPanelFixer_occludedby"); // "occluded by <<1>>"
        ...
        public static string SolarPanelFixer_SelectTrackingBody = GetLoc("SolarPanelFixer_SelectTrackingBody"); // "Select Tracking Body"
        ...
        KopernicusStar[] orderedStarsUse;
        ...
        public void Update()
        {
            ...
            switch (exposureState)
            {
                ...
                case ExposureState.Exposed:
                    ...
                    sb.Append(EcUIUnit);
                    sb.Append("\n");
                    sb.Append(SolarPanelFixer_exposure);//exposure
                    sb.Append(": ");
            ...
            {
                BuildString(currentOutput.ToString(rateFormat), " ", EcUIUnit, ", ", panelStatus);
            }
        }
        ...
        public void FixedUpdate()
        {
            ...
            Vector3d position = VesselPosition(vessel);
            ...
            for (Int32 s = 0; s < KopernicusStar.Stars.Count; s++)
            {
                ...
                if (star != trackedSun && solarFluxTotal < 1e-6)
                    continue;
                ...
                else if (star == trackedSun) exposureState = ExposureState.InShadow;
            }
